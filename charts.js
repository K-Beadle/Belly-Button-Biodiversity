...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // (Deliverable Three) 2. Create a variable that holds the first sample in the metadata array.
    ...
    // (Deliverable Three) 3. Create a variable that holds the washing frequency.
    Object.entries(metadataResults).forEach(([key,value]) => {
      wfreq = metadataResults['wfreq'];
    });
      console.log(wfreq);
